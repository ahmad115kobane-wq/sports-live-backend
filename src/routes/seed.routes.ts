    ...
    await prisma.legalPage.createMany({
      data: [
        ...
        },
        {
          ...
          content: 'Terms of Service\n\nBy using Mini Football Iraq, you agree to the following terms.',
          contentAr: 'شروط الاستخدام\n\nباستخدامك لتطبيق Mini Football Iraq، فإنك توافق على الشروط التالية.',
          contentKu: 'مەرجەکانی بەکارهێنان\n\nبە بەکارهێنانی Mini Football Iraq، ڕازی دەبیت بەم مەرجانە.',
          isActive: true,
          sortOrder: 2,
        },
        {
  ...
  try {
    const defaultPages = [
      ...
      },
      {
        ...
        contentKu: 'مەرجەکانی بەکارهێنان\n\nبە بەکارهێنانی ئەپی Mini Football Iraq، ڕازی دەبیت بەم مەرجانە.',
        isActive: true,
        sortOrder: 2,
      },
      {
